            ...
            {(summary) => (
              <div className="grid md:grid-cols-3 gap-4">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-xl p-5">
                  ...
                  <span className="text-3xl font-bold text-destructive">${(summary.churnExposure / 1000)}k</span>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass rounded-xl p-5">
                  ...
                  <span className="text-3xl font-bold text-warning">${(summary.absenceCost / 1000)}k</span><span className="text-sm text-muted-foreground">/yr</span>
                </motion.div>
